...
[Look into the challenge study different files ]
...
![Code execution](path/to/image2.png)
...
- `tool2` - What it was used for
- `tool3` - What it was used for

## References

- [Reference Link 1](https://example.com) - Description
- [Reference Link 2](https://example.com) - Description
- [Reference Link 3](https://example.com) - Description
